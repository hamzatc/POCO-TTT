...
#SBATCH --output=sbatch/logs/poco_baseline_%j.out
#SBATCH --error=sbatch/logs/poco_baseline_%j.err

# POCO Baseline Training
# Standard supervised training for comparison with TTT methods
