...
#SBATCH --output=sbatch/logs/single_session_celegans_%j.out
#SBATCH --error=sbatch/logs/single_session_celegans_%j.err
...
yes | python -u main.py -t single_session_celegans_flavell
